...
slug: "blockchain-problem-of-bitcoin"
draft: false
---
...
The original achievement still matters. In the [white paper](https://bitcoin.org/en/bitcoin-paper), Satoshi solved the double-spending problem without relying on a central authority. That is not a small thing. Bitcoin created digital scarcity and a settlement system that can survive without a state or a corporation sitting in the middle.
...
This is why the [Lightning Network](https://lightning.network/) matters so much. Lightning promises instant, low-cost payments by moving activity off-chain and using the base layer as a security anchor. I am not dismissing that. In fact, I think Lightning is one of the most important reasons to stay constructive on Bitcoin's future.

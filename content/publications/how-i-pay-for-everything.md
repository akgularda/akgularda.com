...
draft: false
faq:
  - q: "Is cash still necessary for daily life?"
    a: "Not for mine. Transit, groceries, rent transfers, and campus spending all clear by card or instant transfer. Cash only appears when a specific merchant has no terminal, which is rarer every year."
  - q: "What do you give up when you stop carrying cash?"
    a: "The main loss is the physical budgeting ritual — splitting notes into envelopes or pockets. I replaced it with card app categories and a weekly spend review, which gives me a cleaner record than loose change ever did."
  - q: "How do you keep a student budget under control without cash?"
...
- One primary card for daily spend; no loyalty-card pile in the same slot.
- Categories reviewed once a week for five minutes, not after every purchase.
- Instant transfers for anything recurring, so I am not renegotiating deadlines in my head.
...
Bank for International Settlements. (n.d.). *Red Book Statistics on Payment and Settlement Systems*. https://www.bis.org/statistics/payment_statistics.htm

European Central Bank. (2024). *SPACE: Survey on the attitudes of consumers in Europe*. https://www.ecb.europa.eu/stats/ecb_surveys/space/html/index.en.html

Türkiye Cumhuriyet Merkez Bankası. (n.d.). *Payment Systems*. https://www.tcmb.gov.tr/wps/wcm/connect/TR/TCMB+TR/Main+Menu/Payment+Systems/
